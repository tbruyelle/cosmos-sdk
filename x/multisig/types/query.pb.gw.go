...
var (
	filter_Query_Account_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"cosmos", "multisig", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Account_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"cosmos", "multisig", "v1", "account"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Proposals_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"cosmos", "multisig", "v1", "proposals"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Proposal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"cosmos", "multisig", "v1", "proposal"}, "", runtime.AssumeColonVerbOpt(false)))
)
